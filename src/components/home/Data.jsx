...
const Data = () => {
    return (
        <div className="home__data">
            <h3 className="home__title">Hello, <br/> I'm Kevin Carrascal
            <svg 
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__line"></p><br />
            <h1 className="home__subtitle">I'm a full-stack web developer.</h1>
                <a href="#contact" className="button button--flex button-contact">
                   Contact me

              <svg class="button__icon" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
